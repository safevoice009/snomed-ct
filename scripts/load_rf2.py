...
CORE_SEEDS = {
    ...
    "brands": [
        ...
        ("Azee 500", "Azithromycin", "Antibiotic", None, "500mg", "azee, azee 500, azithral, azithral 500, zithrox, aziwok, azimax"),
        ...
        ("Pan-D", "Pantoprazole and domperidone", "Antacid + Antiemetic", None, "40mg/30mg", "pan d, pan-d, pantocid-d, pantop-d, panto-dom"),
        ("Zerodol-SP", "Aceclofenac, paracetamol and serratiopeptidase", "Triple NSAID", None, "100mg/325mg/15mg", "zerodol sp, zerodol-sp, hifenac-sp, aceclo-sp, dolokind-sp"),
        ("Combiflam", "Ibuprofen and paracetamol", "NSAID Combo", None, "400mg/325mg", "combiflam, combiflam plus, brufen plus"),
        ...
        ("Telma-H", "Telmisartan and hydrochlorothiazide", "Antihypertensive Combo", None, "40mg/12.5mg", "telma h, telma-h, telmikind-h, telvas-h"),
        ("Shelcal 500", "Calcium and vitamin D3", "Mineral Supplement", None, "500mg/250IU", "shelcal, shelcal 500, cipcal, calcimax"),
        ...
        ("Glycomet-GP 2", "Glimepiride and metformin", "Antidiabetic Combo", None, "2mg/500mg", "glycomet gp, glycomet-gp 2, gemer 2, zoryl-m 2"),
        ...
        ("Norflox-TZ", "Norfloxacin and tinidazole", "Gastrointestinal Antibiotic", None, "400mg/600mg", "norflox tz, norflox-tz, norbactin-tz"),
        ("Lasix 40", "Furosemide", "Loop Diuretic", "387158000", "40mg", "lasix, lasix 40, fruselac"),
        ("ORS Electral", "Oral rehydration salts", "Electrolyte Solution", None, "1 sachet in 1L", "electral, ors, ors electral, reliance ors, walyte"),
        ("Meftal-Spas", "Mefenamic acid and dicyclomine", "Antispasmodic", None, "250mg/10mg", "meftal spas, meftal-spas, meftal, cyclopam, colimex"),
        ("Allegra 120", "Fexofenadine", "Antihistamine", None, "120mg", "allegra, allegra 120, fexova, fexy, histafree"),
        ("Omez 20", "Omeprazole", "Proton Pump Inhibitor", None, "20mg", "omez, omez 20, omez-d, omecip, omee"),
        ("Rantac 150", "Ranitidine", "H2 Blocker", None, "150mg", "rantac, rantac 150, aciloc, zinetac, histac"),
        ("Montek-LC", "Montelukast and levocetirizine", "Antiasthmatic/Antiallergic", None, "10mg/5mg", "montek lc, montek-lc, montair lc, monticope"),
        ("Asthalin 100", "Salbutamol", "Bronchodilator Inhaler", "387247003", "100mcg", "asthalin, asthalin 100, ventorlin, aerocort"),
        ("Foracort 200", "Formoterol and budesonide", "Inhaler Combo", None, "6mcg/200mcg", "foracort, foracort 200, foracort 400, budecort, seroflo"),
        ("Jardiance 10", "Empagliflozin", "SGLT2 Inhibitor", None, "10mg", "jardiance, jardiance 10, jardiance 25, gibtulio"),
        ("Galvus Met", "Vildagliptin and metformin", "Antidiabetic Combo", None, "50mg/500mg", "galvus met, galvus-met, jalra-m, vilget-m"),
        ("Januvia 100", "Sitagliptin", "DPP-4 Inhibitor", None, "100mg", "januvia, januvia 100, istavel, sitaglyn"),
        ("Ecosprin 75", "Aspirin", "Antiplatelet", None, "75mg", "ecosprin, ecosprin 75, ecosprin 150, asa 75, disprin"),
        ("Clopilet 75", "Clopidogrel", "Antiplatelet", None, "75mg", "clopilet, clopilet 75, deplatt, ceruvit, plavix"),
        ("Thyronorm 50", "Levothyroxine", "Thyroid Hormone", "40930008", "50mcg", "thyronorm, thyronorm 50, thyronorm 25, thyronorm 100, eltroxin"),
        ("Febutaz 40", "Febuxostat", "Antigout", None, "40mg", "febutaz, febutaz 40, febuxor, urikind"),
        ("Urimax 0.4", "Tamsulosin", "Alpha Blocker (BPH)", None, "0.4mg", "urimax, urimax 0.4, veltam, tamflo, urimax-d"),
        ("Folvite 5", "Folic acid", "Vitamin Supplement", None, "5mg", "folvite, folvite 5, fol 5, vitafol"),
        ("Becosules", "Vitamin B Complex with Vitamin C", "Multivitamin", None, "Capsule", "becosules, becosule, b-complex, cobadex forte"),
        ("Neurobion Forte", "Vitamin B1, B6, B12", "Neurotropic Vitamin", None, "Tablet", "neurobion, neurobion forte, nervz-b, optineuron"),
        ("Liv-52", "Ayurvedic Hepatoprotective Herbal formulation", "Liver Supplement", None, "Tablet/Syrup", "liv 52, liv-52, liv52, amlycure"),
        ("Digene", "Magnesium hydroxide, aluminium hydroxide and simethicone", "Antacid", None, "Tablet/Gel", "digene, gelusil, mucaine, rennie"),
        ("Cremaffin", "Liquid paraffin and milk of magnesia", "Laxative", None, "Syrup", "cremaffin, cremaffin plus, dulcoflex, kayam churna"),
        ("Ondem 4", "Ondansetron", "Antiemetic", None, "4mg", "ondem, ondem 4, emeset, emeset 4, vomikind"),
        ("Limcee 500", "Ascorbic acid (Vitamin C)", "Antioxidant / Vitamin", None, "500mg", "limcee, limcee 500, celin, celin 500, suckcee"),
        ("Zincovit", "Multivitamin with Zinc", "Immunity Supplement", None, "Tablet/Syrup", "zincovit, zincovit cl, a to z, supradyn")
    ]
}
